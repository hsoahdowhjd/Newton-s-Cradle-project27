...
function setup() {
	...
	bob1 = new bob(320,975,40)
	bob2 = new bob(360,975,40)
	bob3 = new bob(400,975,40)
	bob4 = new bob(440,975,40)
	bob5 = new bob(480,975,40)
...
function draw() {
 ...
 function keyPressed() {
	 ...
	 if (keyCode === 32) {
		Matter.Body.applyForce(bob1.body,bob1.body.position,{x:-70,y:-65});
		Matter.Body.applyForce(bob2.body,bob2.body.position,{x:-70,y:-65});
	}
 }
